        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <div className="text-right">
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 mb-4">
              ...
              <span className="font-label-sm text-label-sm text-primary">فرق العمل</span>
            </div>
            <h2 className="font-h2 text-h2 text-on-surface mb-3">من المواهب إلى الفاعلية</h2>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
              تعرّف إلى فرق العمل التخصصية والميدانية في أكاديمية جيل الترجيح، واختر المساحة التي توظّف فيها معرفتك أو مهارتك أو موهبتك ضمن عملٍ منظّم وإنجازٍ نافع.
            </p>
          </div>
